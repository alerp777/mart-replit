...
export const NAV_GROUPS: readonly NavGroup[] = [
  {
    ...
    items: [
      ...
      { nameKey: "navAccountRestrictions" as TranslationKey, href: "/account-conditions", icon: Shield },
      { nameKey: "navRestrictionRuleConfig" as TranslationKey, href: "/condition-rules", icon: Settings2 },
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: "navAdminActionLog" as TranslationKey, href: "/audit-logs", icon: ClipboardList },
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: "navCommunications" as TranslationKey,       href: "/communications",  icon: Radio },
    ],
  },
  {
    key: "analytics",
...
export const NAV_DESCRIPTIONS: Readonly<Record<string, string>> = {
  ...
  "/account-conditions":   "Apply or lift restrictions on specific accounts",
  "/condition-rules":      "Configure default rules per restriction type",
  ...
  "/communications":        "Send broadcasts, view notification logs, and messaging KPIs",
  "/broadcast":             "Send notifications to segments (legacy — use /communications)",
  "/notifications":         "Outbound notifications log (legacy — use /communications)",
  "/communication":         "Messaging KPIs and dashboards (legacy — use /communications)",
