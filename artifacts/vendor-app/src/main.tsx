...
if (import.meta.env.DEV) {
  ...
  if (!apiTarget) {
    console.warn("[AJKMart Vendor] VITE_API_PROXY_TARGET is not set — API proxy may point to wrong host. Fix: add VITE_API_PROXY_TARGET as a Replit Secret or in your .env file, then restart.");
  }
}
