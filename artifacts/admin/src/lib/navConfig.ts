...
export const NAV_GROUPS: readonly NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: "navLiveRidersMap",  href: "/live-riders-map", icon: Navigation, requirePermission: "fleet.rides.view" },
  ...
  },
  {
    ...
    items: [
      ...
      { nameKey: "navRolesPermissions" as TranslationKey, href: "/roles-permissions", icon: Shield, requirePermission: "system.roles.manage" },
    ],
  },
  {
    key: "catalog",
  ...
  },
  {
    ...
    color: "#06B6D4",
    items: [
      { nameKey: "navCommunications" as TranslationKey,       href: "/communications",              icon: Radio,         requirePermission: "support.broadcast.send" },
